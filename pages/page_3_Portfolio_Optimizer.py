...
def safe_yf_download(*args, **kwargs):
    ...
    for attempt in range(max_retries):
        try:
            ...
            data = yf.download(*args, **kwargs, raise_errors=True)
...
# Emergency controls for page 3
with st.sidebar.expander("🚨 Emergency Controls"):
    if st.button("🔄 Clear Cache", key="page3_reload"):
        st.cache_data.clear()
        st.rerun()
